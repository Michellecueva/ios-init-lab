...
let myFavoriteBook = Book(title: "Becoming", author: "Michelle Obama", pages: 463, price: 17.95)

print("My favorite book is called \(myFavoriteBook.title). It is written by \(myFavoriteBook.author). It is \(myFavoriteBook.pages) pages long as it sells for $\(myFavoriteBook.price).")
/*:
 ...
 */
let myHeight = Height(heightInInches: 63.6)
