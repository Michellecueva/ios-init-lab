...
struct User {
    ...
    static var currentUser = User.init(userName: "Michelle", email: "Michelle.gmail", age: 27)
...
let steven = User(userName: "Steven", email: "Steven@gmail.com", age: 28)

User.logIn(user: steven)
/*:
