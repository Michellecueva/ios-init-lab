 ...
 */
let Michelle = User(name: "Michelle", age: 27, height: 5.3, weight: 170, activityLevel: 3, typeOfActivity: "biking")

print("My name is \(Michelle.name) and I am \(Michelle.age) years old. I am \(Michelle.height) feet tall and weight \(Michelle.weight) lbs. The type of activity I did today was \(Michelle.typeOfActivity) and my activity level was a \(Michelle.activityLevel) out of 10.")
/*:
