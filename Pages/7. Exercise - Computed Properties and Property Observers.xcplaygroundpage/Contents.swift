...
struct Rectangle {
    var width: Int
    var height: Int
    var area: Int {return width * height} // ask if i need a getter here
}
...
struct Height {
    ...
    var heightInInches: Double {
        didSet {
            if self.heightInInches == self.heightInCentimeters / 2.54 {
                return
            } else {
    ...
    var heightInCentimeters: Double {
        didSet {
            if self.heightInCentimeters == self.heightInInches * 2.54 {
                return
            } else {
                self.heightInInches = self.heightInCentimeters / 2.54
            }
        }
    }
...
var test = Height(heightInCentimeters: 30)

print(test.heightInInches)
